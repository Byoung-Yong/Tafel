...
The app is configured as a standard Next.js app. Vercel should use its default Next.js build output; do not set a custom output directory.
...
6. Output directory: leave empty / Vercel default.
7. Deploy.
